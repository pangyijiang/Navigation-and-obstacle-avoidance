...
from keras.layers import Input, Dense, Reshape, Lambda, BatchNormalization, GaussianNoise, Flatten, Dropout
...
class Actor:
    ...
    def network(self):
        ...
        """
        In = Input(shape=[self.env_dim], name='state_input')
        #inp = Input((self.env_dim))
        #
        X = Dense(256, activation='relu')(In)
