...
class ROBOT(pg.sprite.Sprite):
    ...
    def reward_cal(self):
        ...
        # if self.robot_pose[0] > self.map.MAP_SIZE[0] or self.robot_pose[1] > self.map.MAP_SIZE[1] or self.robot_pose[0] < 0 or self.robot_pose[1] < 0:
        #     reward += -1
    ...
    def _obs(self):
        ...
        if flag:
            ...
            # subplt1.scatter(X_1, Y_1, c = "r")
            # subplt1.scatter(X_2, Y_2, c = "b")
            # subplt1.scatter(X_3, Y_3, c = "y")
            plt.show()
