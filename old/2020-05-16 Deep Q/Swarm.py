...
class SWARM():
    ...
    def init_swarm(self):
        ...
        for i in range(self.num_uavs):
            ...
            state.append(self.uavs[i].get_state())
...
class ROBOT(pg.sprite.Sprite):
    ...
    def get_state(self):
        ...
        pos_robot = self.robot_pose/(sum(self.map.MAP_SIZE)/2)    #scale
        pos_goal = self.robot_goal/(sum(self.map.MAP_SIZE)/2)    #scale
    ...
    def _status_update(self, action):
        ...
        self._robot_clk(vel_ctl*self.vel_max)
