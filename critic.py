...
from keras.layers import Input, Dense, Concatenate, LSTM, Reshape, BatchNormalization, Lambda, Flatten, Add, ReLU, Dropout
...
class Critic:
    ...
    def network(self):
        ...
        X_1 = Dense(256, activation='relu')(state_input)
        ...
        # X_2 = Dense(128, activation='linear')(X_2)
